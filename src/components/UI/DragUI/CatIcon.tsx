...
<svg
              ...
              version="1.1"
              xmlSpace="preserve"
              //transform={`translate(${movement.translateX} ,${movement.translateY}) rotate(${movement.rotateClockWise}) rotate(${movement.rotateAntiClockWise})`}
              // transform={`translate(${position.x} ,${position.y}) rotate(${movement.rotateClockWise}) rotate(${movement.rotateAntiClockWise})`}
            //   onMouseMove={handleMouseMove}
            //   onMouseUp={handleMouseUp}
            //   onMouseLeave={handleMouseUp}
            // onMouseDown={handleMouseDown} inside lower g
            >
              <g>
